...
flip_pairs = ((2, 5), (3, 6), (4, 7), (8, 11),
              (9, 12), (10, 13), (17, 18), (19, 20))
skeleton = ((0, 16), (16, 1), (1, 15), (15, 14), (14, 8), (14, 11), (8, 9), (9, 10), (10, 19),
...
with open(tmp_file_path, "rb") as f:
    ckpt = torch.load(f, map_location=lambda storage, loc: storage.cuda(), weights_only = False)
...
root_depth_list = [11250.5732421875, 15522.8701171875,
                   11831.3828125, 8852.556640625, 12572.5966796875]
...
for n in range(person_num):
    bbox = process_bbox(
        np.array(bbox_list[n]), original_img_width, original_img_height)
    ...
    pose_3d[:, 2] = (pose_3d[:, 2] / cfg.depth_dim * 2 - 1) * \
        (cfg.bbox_3d_shape[0]/2) + root_depth_list[n]
...
vis_3d_multiple_skeleton(vis_kps, np.ones_like(
    vis_kps), skeleton, 'output_pose_3d (x,y,z: camera-centered. mm.)')
